...
function createCityGuide(key, keyState)
	...
	if not (wGuidebook) then
		...
		showCursor(true)
		-- the image
		page = guiCreateStaticImage (0.01, 0.05, 0.8, 0.95, "public/images/guide/" ..  click_count  .. ".png", true, wGuidebook)
	else
		closeButtonClick()
	end
end
...
function prevButtonClick()
	...
	guiStaticImageLoadImage (page,"public/images/guide/" .. click_count  .. ".png")
end
