...
addEvent("playRadarFineSound", true)
addEventHandler("playRadarFineSound", resourceRoot, function()
    playSound("")
	exports.rl_infobox:addBox("info", "Radara takıldığın için 300₺ ceza yedin, vergine yansıdı.")
end)