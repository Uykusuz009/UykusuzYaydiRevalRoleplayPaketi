function showGUI(partnerName, price)
	...
	window = guiCreateWindow(0, 0, 454, 330, "RevalMTA - Zar Düellosu", false)
...
addEvent('Karazindan:pairs:showGUI', true)
addEventHandler('Karazindan:pairs:showGUI', root, showGUI)

function inviteGUI(partnerName, price)
	window = guiCreateWindow(722, 463, 483, 167, "RevalMTA - Bahis İsteği", false)
	guiWindowSetSizable(window, false)
	exports.rl_global:centerWindow(window)
...
addEvent('Karazindan:pairs:inviteGUI', true)
addEventHandler('Karazindan:pairs:inviteGUI', root, inviteGUI)
