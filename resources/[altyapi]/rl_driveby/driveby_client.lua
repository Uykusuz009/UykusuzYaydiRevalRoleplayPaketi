...
function toggleDriveby()
	...
	if windowState == 0 then
		outputChatBox("[!]#FFFFFF Pencereden çıkmak için aracın camı açık olmalıdır.", 255, 0, 0, true)
		playSoundFrontEnd(4)
		return
	end
	local spawnProtection = getElementData(localPlayer, "spawn_protection") or false
