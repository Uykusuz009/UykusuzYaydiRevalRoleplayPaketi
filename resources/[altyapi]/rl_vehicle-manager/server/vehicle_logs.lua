...
function getVehicleOwner(vehicle)
	...
	if faction > 0 then
		return getTeamName(exports.rl_pool:getElement('team', faction))
	else
		return call(getResourceFromName("rl_cache"), "getCharacterName", getElementData(vehicle, "owner")) or "N/A"
	end
end