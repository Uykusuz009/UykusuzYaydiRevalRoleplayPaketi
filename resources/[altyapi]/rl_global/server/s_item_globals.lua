...
function giveItem( element, itemID, itemValue )
	return call( getResourceFromName( "erp_items" ), "giveItem", element, itemID, itemValue, false, true )
end

function takeItem( element, itemID, itemValue )
	return call( getResourceFromName( "erp_items" ), "takeItem", element, itemID, itemValue )
end
