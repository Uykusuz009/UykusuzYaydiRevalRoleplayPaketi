...
function createShader()
        ...
        blurHShader,tecName = dxCreateShader( "files/blurH.fx" )
        blurVShader,tecName = dxCreateShader( "files/blurV.fx" )
...
function bluredRectangle(pos_x, pos_y, size_x, size_y, color)
