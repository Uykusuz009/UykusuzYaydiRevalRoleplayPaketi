...
function showsize(thePlayer)
	if not exports.rl_integration:isPlayerDeveloper(thePlayer) then
		return false
	end
...
addEventHandler("onResourceStop", resourceRoot, function()
	exports.rl_data:save(poolTable, "poolTable")
	exports.rl_data:save(indexedPools, "indexedPools")
end)

addEventHandler("onResourceStart", resourceRoot, function()
	local loaded = exports.rl_data:get("poolTable")
	if loaded then
		poolTable = loaded
	end
	loaded = exports.rl_data:get("indexedPools")
	if loaded then
		indexedPools = loaded
	end
