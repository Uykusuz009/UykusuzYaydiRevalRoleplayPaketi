...
local serverColor = exports.rl_ui:getServerColor(4)
...
function dxDrawInteractionButton(key, label, x, y, w, h, buttonColor, activeColor, textColor, font, textAlign1, textAlign2, imagePath, imageW, imageH, imageColor)
	...
	dxDrawRectangle(x + 10, y, w - 20, h-5, exports.rl_ui:inArea(x + 10, y, w - 20, h - 5) and exports.rl_ui:rgba(theme.GRAY[700]) or exports.rl_ui:rgba(theme.GRAY[800]))

    textAlign1 = textAlign1 or "center"
    textAlign2 = textAlign2 or "center"
    local font2 = exports.kaisen_fonts:getFont("UbuntuRegular", 10)
