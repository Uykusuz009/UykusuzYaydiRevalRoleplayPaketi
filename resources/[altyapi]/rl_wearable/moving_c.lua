...
function wearable_recieve_position(ITEM_POSITION)
  if type(ITEM_POSITION) == "table" then
    ...
    exports.rl_bones:attachElementToBone(object, localPlayer, wearable_bone, ITEM_X, ITEM_Y, ITEM_Z, ITEM_RX, ITEM_RY, ITEM_RZ)
...
function moving_object(objectID, dbid)
  ...
  self.activeSlot = "arrowicon.png"
  local _, _, X_ATTACH, Y_ATTACH, Z_ATTACH, RX_ATTACH, RY_ATTACH, RZ_ATTACH = exports.rl_bones:getElementBoneAttachmentDetails(object)
  exports.rl_bones:attachElementToBone(object, localPlayer, wearable_bone, 0, 0, 0, 0, 0, 0)
  for index = 1, self.cuboid do
    ...
    for index, data in pairs(positions.images) do
      ...
      if shownImage then
        ...
        if SCREEN_X or SCREEN_Y then
          ...
          if exports.rl_ui:inArea(posX, posY, posW, posH) then
...
function wearable_move_object(POSITION_VALUE)
  ...
  exports.rl_bones:attachElementToBone(object, localPlayer, wearable_bone, default_position[1], default_position[2], default_position[3], default_position[4], default_position[5], default_position[6])
end
