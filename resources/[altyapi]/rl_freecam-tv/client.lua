...
addEventHandler("doSetFreecamEnabledTV", root, setFreecamEnabled)

addEvent("doSetFreecamDisabledTV", true)
addEventHandler("doSetFreecamDisabledTV", root, setFreecamDisabled)

addEvent("doSetFreecamOptionTV", true)
addEventHandler("doSetFreecamOptionTV", root, setFreecamOption)
