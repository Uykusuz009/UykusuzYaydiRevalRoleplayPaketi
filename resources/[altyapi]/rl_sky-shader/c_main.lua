...
function startDynamicSky()
	...
	addEventHandler ( "onClientPreRender", root, renderSphere ) -- sphere
	addEventHandler ( "onClientPreRender", root, renderTime ) -- time
	shaderTable.isSwitched = false
	addEventHandler ( "onClientPreRender", root, switchShaders ) -- change shaders
	dsEffectEnabled = true
end

function stopDynamicSky()
	if not dsEffectEnabled then return end
	removeEventHandler ( "onClientPreRender", root, renderSphere ) -- sphere
	removeEventHandler ( "onClientPreRender", root, renderTime ) -- time
	removeEventHandler ( "onClientPreRender", root, switchShaders ) -- change shaders
