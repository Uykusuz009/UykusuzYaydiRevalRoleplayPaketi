integration = exports.rl_integration -- Don't do stuff like this for too many resources cuz it requires a correct ordering of resources in mtaserver.cnf or else your script fails to work everytime server restarts. Can be annoying and impossible sometimes. / Farid
global = exports.rl_global
pool = exports.rl_pool
...
addEventHandler('onResourceStart', resourceRoot, function()
	...
	local worldItems = getElementsByType("object", getResourceRootElement(getResourceFromName("rl_item-world")))
