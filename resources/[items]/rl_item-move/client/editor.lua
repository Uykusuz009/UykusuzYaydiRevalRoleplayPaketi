...
local function canEditObject(object)
  return exports.rl_integration:isAdminOnDuty(localPlayer) or exports.rl_integration:isPlayerDeveloper(localPlayer)
end
...
addEventHandler('item:move', root,
  function(object)
    ...
    if editing and object then
      ...
      bSave = guiCreateButton(145, 200, 65, 20, 'Yadda Saxla', false, wInfo)
