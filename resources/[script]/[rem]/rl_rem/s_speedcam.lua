...
local policeVehicles = {[523] = true, [598] = true, [596] = true, [597] = true}
local governmentVehicles = {[523] = true, [598] = true, [596] = true, [597] = true}
local colors = {
...
addCommandHandler({"togspeedcamera", "togglespeedcamera", "togspeedcam", "togglespeedcam", "togspeed", "togglespeed"},
	function(player, cmd, speed)
		...
		if vehicle then
			if tonumber(getElementData(vehicle, "faction")) == 1 and (getVehicleController(vehicle) == player) then
