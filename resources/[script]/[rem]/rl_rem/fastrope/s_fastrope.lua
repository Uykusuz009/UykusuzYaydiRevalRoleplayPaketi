function startRappel(x, y, z, gz)
	...
	--exports.rl_anticheat:changeProtectedElementDataEx(source, "realinvehicle", 0, false)
	...
	exports.rl_global:applyAnimation(source, "PARACHUTE", "PARA_float", true, 1.0, false, false)
