							...
							setTimer(function(hitElement, x, y, z, kmh)
								...
								if isVerifiedElement(radar, "vehicle") and getElementData(radar, "speedcamera:state") then
									...
									for seat,player in pairs(getVehicleOccupants(radar)) do
										outputChatBox("[RADAR] A " .. getColorName(c1, c2) .. " " .. exports.rl_global:getVehicleName(hitElement) .. " was clocked travelling at " .. tonumber(kmh) .. " km/h and is heading " .. direction .. ".", player, 255, 180, 20, false)
