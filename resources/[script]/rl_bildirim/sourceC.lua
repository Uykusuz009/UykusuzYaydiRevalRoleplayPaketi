...
addEventHandler('onClientRender', root,
	function()
		for k, v in pairs(notificationData) do
			...
			elseif (v.Type == 'reval') then
				dxDrawText('Ꮢ', v.CurrentX + 5, 20, v.CurrentX + 5 + 25 - 10, 20 + 25, tocolor(155, 155, 155, v.Alpha), 0.50, iconsFont, 'center', 'center', false, false, true);
			end
		end
	end
)
