...
addCommandHandler(antiLag_settings.cmd,
	function(x)
		...
		if (antiLag_settings.status == "off") then
			...
			--exports["fs_bildirim"]:addNotification(thePlayer, "Sohbeti okuyunuz.", "success")			
			outputChatBox("#01ffff[RP]#ffffff Anti-lag aktif edildi, FPS'inizde artış yaşanabilir.", 0, 255, 0, true)
		else
			...
			--exports["fs_bildirim"]:addNotification(thePlayer, "Sohbeti okuyunuz.", "error")					
			outputChatBox("#01ffff[RP]#ffffff Anti-lag de-aktif edildi, bilgisayarınız kötüyse FPS'inizde düşüş yaşanabilir.", 0, 255, 0, true)
		end
	end
)