colors = {
    --['colorname'] = {r, g, b, hex},
    ['red'] = {220, 73, 73, "#fc0000"},
	['green'] = {113, 208, 36, "#72ff00"},
    ['blue'] = {51, 153, 255,"#0400d4"},
	['blue2'] = {36, 109, 208, "#0069f7"},
	['yellow'] = {208, 153, 36, "#ebf700"},
    ["orange"] = {255, 153, 51, "#f57a00"},
    ['lightyellow'] = {255, 209, 26, "#ffcf0f"},
    ["servercolor"] = {135, 211, 124, "#0400d4"}
}
...
serverData = {
    ...
    ['name'] = Reval,
    ['color'] = serverColor,
    ['web'] = 'discord.gg/revalroleplay',
	['mod'] = 'Sen Yoksan Eksiğiz Kanka',
	['city'] = 'Reval',
